...
<div class="landing">
    <div class="container">
        ...
        <div class="image">
            <img src="{{asset('web_assets/imgs/landing-image.png')}}" alt="" />
        </div>
    </div>
...
<div class="features" id="features">
    ...
    <div class="container">
        <div class="box quality">
            <div class="img-holder"><img src="{{asset('web_assets/imgs/features-01.jpg')}}" alt="" /></div>
            <h2>Quality</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit harum hic veniam eligendi minima</p>
            <a href="#">More</a>
        </div>
        <div class="box time">
            <div class="img-holder"><img src="{{asset('web_assets/imgs/features-02.jpg')}}" alt="" /></div>
            <h2>Time</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit harum hic veniam eligendi minima</p>
            <a href="#">More</a>
        </div>
        <div class="box passion">
            <div class="img-holder"><img src="{{asset('web_assets/imgs/features-03.jpg')}}" alt="" /></div>
            <h2>Passion</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit harum hic veniam eligendi minima</p>
            <a href="#">More</a>
        </div>
...
<div class="testimonials" id="testimonials">
    ...
    <div class="container">
        <div class="box">
            <img src="{{asset('web_assets/imgs/avatar-01.png')}}" alt="" />
            <h3>Mohamed Farag</h3>
        ...
        <div class="box">
            <img src="{{asset('web_assets/imgs/avatar-02.png')}}" alt="" />
        ...
        <div class="box">
            <img src="{{asset('web_assets/imgs/avatar-03.png')}}" alt="" />
            <h3>Shady Nabil</h3>
            <span class="title">Full Stack Developer</span>
            <div class="rate">
                <i class="filled fas fa-star"></i>
        ...
        <div class="box">
            <img src="{{asset('web_assets/imgs/avatar-04.png')}}" alt="" />
            <h3>Amr Hendawy</h3>
            <span class="title">Full Stack Developer</span>
            <div class="rate">
                <i class="filled fas fa-star"></i>
        ...
        <div class="box">
            <img src="{{asset('web_assets/imgs/avatar-05.png')}}" alt="" />
        ...
        <div class="box">
            <img src="{{asset('web_assets/imgs/avatar-06.png')}}" alt="" />
            <h3>Osama Mohamed</h3>
            <span class="title">Full Stack Developer</span>
            <div class="rate">
                <i class="filled fas fa-star"></i>
...
<div class="team" id="team">
    ...
    <div class="container">
        <div class="box">
            <div class="data">
                <img src="{{asset('web_assets/imgs/team-01.jpg')}}" alt="" />
                <div class="social">
                    <a href="#">
        ...
        <div class="box">
            <div class="data">
                <img src="{{asset('web_assets/imgs/team-02.jpg')}}" alt="" />
                <div class="social">
                    <a href="#">
                        <i class="fab fa-facebook-f"></i>
                    </a>
        ...
        <div class="box">
            <div class="data">
                <img src="{{asset('web_assets/imgs/team-03.jpg')}}" alt="" />
                <div class="social">
                    <a href="#">
                        <i class="fab fa-facebook-f"></i>
                    </a>
        ...
        <div class="box">
            <div class="data">
                <img src="{{asset('web_assets/imgs/team-04.jpg')}}" alt="" />
                <div class="social">
                    <a href="#">
                        <i class="fab fa-facebook-f"></i>
                    </a>
        ...
        <div class="box">
            <div class="data">
                <img src="{{asset('web_assets/imgs/team-05.png')}}" alt="" />
                <div class="social">
                    <a href="#">
                        <i class="fab fa-facebook-f"></i>
                    </a>
        ...
        <div class="box">
            <div class="data">
                <img src="{{asset('web_assets/imgs/team-06.png')}}" alt="" />
                <div class="social">
                    <a href="#">
                        <i class="fab fa-facebook-f"></i>
                    </a>
        ...
        <div class="box">
            <div class="data">
                <img src="{{asset('web_assets/imgs/team-07.jpg')}}" alt="" />
                <div class="social">
                    <a href="#">
                        <i class="fab fa-facebook-f"></i>
                    </a>
        ...
        <div class="box">
            <div class="data">
                <img src="{{asset('web_assets/imgs/team-08.jpg')}}" alt="" />
                <div class="social">
                    <a href="#">
                        <i class="fab fa-facebook-f"></i>
                    </a>
...
<div class="our-skills" id="our-skills">
    ...
    <div class="container">
        <img src="{{asset('web_assets/imgs/skills.png')}}" alt="" />
        <div class="skills">
            <div class="skill">
...
<div class="work-steps" id="work-steps">
    ...
    <div class="container">
        <img src="{{asset('web_assets/imgs/work-steps.png')}}" alt="" class="image" />
        <div class="info">
            <div class="box">
                <img src="{{asset('web_assets/imgs/work-steps-1.png')}}" alt="" />
                <div class="text">
            ...
            <div class="box">
                <img src="{{asset('web_assets/imgs/work-steps-2.png')}}" alt="" />
                <div class="text">
                    <h3>Architecture</h3>
                    <p>
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Enim nesciunt obcaecati quisquam quis laborum
            ...
            <div class="box">
                <img src="{{asset('web_assets/imgs/work-steps-3.png')}}" alt="" />
                <div class="text">
                    <h3>Developement</h3>
                    <p>
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Enim nesciunt obcaecati quisquam quis laborum
...
<div class="events" id="events">
    ...
    <div class="container">
        <img src="{{asset('web_assets/imgs/events.png')}}" alt="" />
        <div class="info">
            <div class="time">
                <div class="unit">
...
<div class="pricing" id="pricing">
    ...
    <div class="container">
        <div class="box">
            ...
            <img src="{{asset('web_assets/imgs/hosting-basic.png')}}" alt="" />
            <div class="price">
        ...
        <div class="box popular">
            ...
            <img src="{{asset('web_assets/imgs/hosting-advanced.png')}}" alt="" />
            <div class="price">
        ...
        <div class="box">
            ...
            <img src="{{asset('web_assets/imgs/hosting-professional.png')}}" alt="" />
            <div class="price">
...
<div class="videos" id="videos">
    ...
    <div class="container">
        <div class="holder">
            ...
            <div class="preview">
                <img src="{{asset('web_assets/imgs/video-preview.jpg')}}" alt="" />
...
<div class="discount" id="discount">
    <div class="image">
        <div class="content">
            ...
            <img src="{{asset('web_assets/imgs/discount.png')}}" alt="" />
        </div>
    </div>
    <div class="form">
        <div class="content">
