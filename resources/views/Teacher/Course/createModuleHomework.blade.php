...
<head>
    ...
    <title>Add Module Homework</title>
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">Create Homework for Module: {{ $module->name }}</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive mb-4">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach($homeworks as $existingHomework)
                                        <tr>
                                            <td>{{ $existingHomework->name }}</td>
                                            <td>{{ $existingHomework->description }}</td>
                                            <td>{{ $existingHomework->total_mark }}</td>
                                            <td>
                                                @php
                                                    $questionCount = optional($existingHomework->questions)->count() ?? 0;
                                                @endphp
                                                {{ $questionCount }}
                                            </td>
                                            <td>
                                                <a href="{{ route('teacher.course.module.homework.questions', ['homework_id' => $existingHomework->id]) }}" 
                            ...
                            <form method="post" action="{{ route('teacher.course.module.homework.store') }}" id="homeworkForm">
                                @csrf
                                <input type="hidden" name="module_id" value="{{ $module->id }}">
                                
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <label class="form-label">Homework Name</label>
                                ...
                                <div class="mt-4">
                                    <button type="submit" class="btn btn-primary">Create New Homework</button>
                                </div>
                            </form>
                        </div>
                    </div>
