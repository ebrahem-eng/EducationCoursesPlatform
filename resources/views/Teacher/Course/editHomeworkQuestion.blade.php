                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <span class="badge bg-primary">Homework: {{ $question->courseModuleHomeWork->name }}</span>
                                <span class="badge bg-info">Module: {{ $question->courseModuleHomeWork->courseModule->name }}</span>
                            </div>
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{ route('teacher.course.module.homework.question.update', ['question_id' => $question->id]) }}">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mt-4">
                                    ...
                                    <a href="{{ route('teacher.course.module.homework.questions', ['homework_id' => $question->course_module_home_work_id]) }}" 
