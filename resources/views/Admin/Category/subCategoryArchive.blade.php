...
<head>
    ...
    <title>Sub Category Archive Table</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        ...
                        <h5 class="card-header">Sub Category Archive Table</h5>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{route('admin.category.restore' , $subCategory->id)}}"
                                                    ><i class="bx bx-arrow-back me-1"></i>
                                                        Restore</a
                                                    >
                                                    <form method="post" action="{{route('admin.category.force.delete' ,$subCategory->id)}}">
                                                        @csrf
                                                        @method('delete')
