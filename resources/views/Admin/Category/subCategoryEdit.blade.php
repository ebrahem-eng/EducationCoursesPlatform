            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{route('admin.category.sub.category.update' , $category->id)}}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <!-- Full Name -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        <label class="form-label" for="basic-icon-default-status">Category</label>
                                        <div class="input-group input-group-merge">
                                            ...
                                            >
                                                ...
                                                @foreach($categories as $categorys)
                                                    <option value="{{$categorys->id}}" {{ $category->parent_id == $categorys->id ? 'selected' : '' }}>{{$categorys->name}}-{{$categorys->code}}</option>
                                                @endforeach
