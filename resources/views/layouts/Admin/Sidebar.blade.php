<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{route('admin.dashboard')}}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Education</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Teacher Management</div>
            </a>
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Authentications">Company Manage</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('admin.company.index') }}" class="menu-link">
                        <div data-i18n="Basic">Company Table</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('admin.company.create') }}" class="menu-link">
                        <div data-i18n="Basic">Create Company</div>
                    </a>
                </li>
            </ul>
        </li>
